...
var StateManager = function StateManager(config) {
    // set config options
    this._config = config || {};
...
proto.pushState = function (state) {
    ...
    this._registerChange(states[this._currentState], // current state
...
proto.back = function () {
    ...
    this._registerChange(this._states[this._currentState], // current state
